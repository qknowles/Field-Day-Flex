...
import { AiOutlineMergeCells, AiOutlineSearch, AiFillEdit, AiFillDelete } from 'react-icons/ai';
...
const iconMap = {
    TurtleIcon: GiTurtle,
    AmphibianIcon: GiFrog,
    ArthropodIcon: GiSpottedBug,
    ...
    NewDataIcon: HiDocumentPlus,
    ColumnToggleIcon: MdViewColumn,
    SortDescIcon: CgSortAz,
    SortAscIcon: CgSortZa,
    SearchIcon: AiOutlineSearch,
    MergeIcon: AiOutlineMergeCells,
    GoogleIcon: FcGoogle,
    EditIcon: AiFillEdit,
    DeleteIcon: AiFillDelete,
    CheckIcon: FaCheck,
    CloseIcon: FaTimes,
    BackArrowIcon: IoIosArrowBack,
    ForwardArrowIcon: IoIosArrowForward,
};

export const icons = Object.keys(iconMap).reduce((acc, name) => {
    acc[name] = (props) => React.createElement(iconMap[name], props);
    return acc;
}, {});
